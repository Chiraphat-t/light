...
def led(total,fingers,led_1,led_2,led_3,led_4,led_5):#creat condition to controll digital out put
    if total==0:
        led_1.write(0)
        led_2.write(0)
        led_3.write(0)
...
with mp_hand.Hands(min_detection_confidence=0.5,
    ...
    while True:
        ...
        if len(lmList)!=0:
            ...
            led(total,fingers,led_1,led_2,led_3,led_4,led_5) #import function in module to control arduino output
            """
